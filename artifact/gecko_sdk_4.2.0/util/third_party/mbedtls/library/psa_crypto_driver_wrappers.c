...
#if defined(SLI_PSA_DRIVER_HSE) && defined(SLI_PSA_DRIVER_FEATURE_OPAQUE_KEYS)
#ifndef PSA_CRYPTO_DRIVER_PRESENT
#define PSA_CRYPTO_DRIVER_PRESENT
#endif
#ifndef PSA_CRYPTO_ACCELERATOR_DRIVER_PRESENT
...
#endif /* SLI_PSA_DRIVER_HSE  && SLI_PSA_DRIVER_FEATURE_OPAQUE_KEYS */

#if defined(SLI_PSA_DRIVER_VSE)
#ifndef PSA_CRYPTO_DRIVER_PRESENT
#define PSA_CRYPTO_DRIVER_PRESENT
#endif
#ifndef PSA_CRYPTO_ACCELERATOR_DRIVER_PRESENT
    ...
    uint8_t *signature, size_t signature_size, size_t *signature_length )
{
    ...
    switch( location )
    {
        case PSA_KEY_LOCATION_LOCAL_STORAGE:
            ...
            if( status != PSA_ERROR_NOT_SUPPORTED )
                return( status );
#elif defined(SLI_PSA_DRIVER_VSE)
            ...
            if( status != PSA_ERROR_NOT_SUPPORTED )
                return( status );
#endif /* SLI_PSA_DRIVER_HSE SLI_PSA_DRIVER_VSE */
#endif /* PSA_CRYPTO_ACCELERATOR_DRIVER_PRESENT */
    ...
    switch( location )
    {
        ...
        case PSA_CRYPTO_TEST_DRIVER_LOCATION:
            return( mbedtls_test_opaque_import_key(
                         ...
                         key_buffer_length, bits ) );
#endif /* PSA_CRYPTO_DRIVER_TEST */
#if defined(SLI_PSA_DRIVER_HSE) && defined(SLI_PSA_DRIVER_FEATURE_WRAPPED_KEYS)
        case PSA_KEY_LOCATION_SLI_SE_OPAQUE:
    ...
    switch( location )
    {
        ...
        case PSA_KEY_LOCATION_SLI_SE_OPAQUE:
            return( sli_se_opaque_get_builtin_key(
                        ...
                        key_buffer, key_buffer_size, key_buffer_length ) );
#endif
#if defined(SLI_PSA_DRIVER_VSE) && defined(SLI_PSA_DRIVER_FEATURE_OPAQUE_KEYS)
