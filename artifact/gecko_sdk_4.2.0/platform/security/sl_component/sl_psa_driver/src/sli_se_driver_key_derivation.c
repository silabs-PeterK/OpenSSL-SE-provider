                                         ...
                                         size_t *output_length)
{
    ...
    #if defined(SLI_PSA_DRIVER_HSE_VAULT_HIGH) && defined(SLI_SE_KEY_PADDING_REQUIRED)
    ...
    #endif // SLI_PSA_DRIVER_HSE_VAULT_HIGH && SLI_SE_KEY_PADDING_REQUIRED
    ...
    #if defined(SLI_SE_KEY_PADDING_REQUIRED) && defined(SLI_SE_KEY_PADDING_REQUIRED)
