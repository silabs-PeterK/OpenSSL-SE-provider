...
static psa_status_t aead_encrypt_tag(const psa_key_attributes_t *attributes,
...
static psa_status_t aead_decrypt_tag(const psa_key_attributes_t *attributes,
                                     const uint8_t *key_buffer,
                                     size_t key_buffer_size,
                                     psa_algorithm_t alg,
                                     const uint8_t *nonce,
                                        ...
                                        size_t *ciphertext_length)
{
    ...
    size_t tag_length = 0;
    psa_status_t psa_status = aead_encrypt_tag(
      attributes,
      key_buffer,
      key_buffer_size,
      alg,
