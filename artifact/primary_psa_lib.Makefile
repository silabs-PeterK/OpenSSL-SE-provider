...
release: | $(OUTPUT_DIR)/$(PROJECTNAME).a
...
$(OUTPUT_DIR)/$(PROJECTNAME).a: $(OBJS)
	@echo 'Creating archive $(OUTPUT_DIR)/$(PROJECTNAME).a'
	$(ECHO)$(AR) -rcs $(OUTPUT_DIR)/$(PROJECTNAME).a $(OBJS)
	@echo 'Done.'
